...
function Footer() {
  return (
    <>
      <footer className=' p-10 bg-gradient-to-b from-[#92f4f8] to-[#026e86] text-white border-[12px] border-b-0 border-white rounded-t-4xl'>
        ...
        <div className='text-white flex justify-between items-center flex-col lg:flex-row w-full'>
          <span className='text-xs sm:text-lg'>
            &copy; All rights reserved, Naviqate 2025
          </span>
